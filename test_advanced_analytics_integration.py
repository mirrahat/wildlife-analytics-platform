...
try:
    ...
    if len(data) > 0:
        # Test trend analysis (with small sample)
        ...
        # Test hotspot detection (with small sample)
        ...
        if report:
            ...
            print("⚠️ Ecosystem health report empty")
        ...
        print("⚠️ No data available for testing. Run ETL pipeline first.")
