#!/usr/bin/env python3
"""
Australian Wildlife Data Collector
==================================
A simple tool for collecting real Australian animal data from public APIs.

What this does:
1. Connects to the iNaturalist wildlife database
2. Searches for recent Australian animal sightings  
3. Shows you live data about koalas, kangaroos, and other species
4. Saves the collected data for further analysis

Uses the iNaturalist API to get real citizen science wildlife observations.
"""
...
def collect_australian_wildlife():
    ...
    print("=" * 45)
    print("Collecting recent Australian wildlife observations")
    print()
    ...
    try:
        ...
        print("NOTE: Check your internet connection and try again")
        return None
...
if __name__ == "__main__":
    ...
    if wildlife_data:
        ...
        print()
        print("What's next?")
        print("   You can now store this data in a database for analysis!")
