#!/usr/bin/env python3
"""
Australian Wildlife Database Explorer

A simple tool to explore the wildlife data you've collected.
    ...
    try:
        with sqlite3.connect(db_name) as connection:
            ...
            if total_count == 0:
                ...
                print("NOTE: Run 'python step2_add_database.py' first to collect some data")
                return
            ...
            print("NOTE: Run 'python step2_add_database.py' again to collect more data!")
            
    except sqlite3.Error as e:
        print(f"ERROR: Database error: {e}")
    except FileNotFoundError:
        print(f"ERROR: Database file '{db_name}' not found!")
        print("NOTE: Run 'python step2_add_database.py' first to create the database")
